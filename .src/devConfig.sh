...
source .bashrc
||||||| parent of 80c847d ((update) Correção de instalação de pacotes de ambiente-dev; Remoção do Redis;)
=======
#!/bin/bash
source .src/functions.sh
...
# Recarreganco o .bashrc
source .bashrc
>>>>>>> 80c847d ((update) Correção de instalação de pacotes de ambiente-dev; Remoção do Redis;)
